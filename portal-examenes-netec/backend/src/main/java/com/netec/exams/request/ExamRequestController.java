...
import com.netec.exams.security.*; import jakarta.validation.Valid; import java.net.URI; import java.security.Principal; import java.util.UUID;
...
class ExamRequestController {
  private final ExamRequestService service; ExamRequestController(ExamRequestService service){this.service=service;}
